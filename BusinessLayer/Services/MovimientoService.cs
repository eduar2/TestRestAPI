...
namespace BusinessLayer.Services
{
    public sealed class MovimientoService: IMovimientoService
    {
        ...
        public List<EstadoCuentum> ConsultMovimientosPorFechas(DateTime FechaInicio, DateTime FechaFin, string IdentificacionCliente)
        {
            try
            {
                string mensaje = null;

                IEnumerable<EstadoCuentum> result = estadoCuentaRepository.GetMovimientosPorFechaCliente(IdentificacionCliente, FechaInicio, FechaFin);
